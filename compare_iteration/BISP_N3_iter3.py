...
def SPEtest(Xs, Ys, Xt, Yt):
    ...
    #Xs_new, Xt_new = tca.fit(netbsd_pre, mysql_pre)
    runs = 1
...
class BDA:
    ...
    def fit_predict(self, Xs, Ys, Xt, Yt):
        ...
        for t in range(self.T):
            ...
            newWs.write(33 + t, jj, '{:.4f}'.format(PD))
            newWs.write(80 + t, jj, '{:.4f}'.format(PF))
            newWs.write(127 + t, jj, '{:.4f}'.format(Bal))
            newWs.write(174 + t, jj, '{:.4f}'.format(AUC))
...
if __name__ == '__main__':
    ...
    # for i in range(10):
    Xs, Ys, Xt, Yt = netbsd_pre, netbsd_y, mysql_pre, mysql_y
