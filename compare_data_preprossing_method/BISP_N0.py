...
# mysql = np.loadtxt('E:\\class-overlap-master\\data\\aging data\\mysql82.csv', delimiter=',', skiprows=1)
# mysql_x = np.delete(mysql, -1, axis=1)
# mysql_y = mysql[:, 82]
...
if __name__ == '__main__':
    ...
    newWs.write(23, 17, '{:.4f}'.format(np.mean(PD1)))
    newWs.write(54, 17, '{:.4f}'.format(np.mean(PF1)))
    newWs.write(85, 17, '{:.4f}'.format(np.mean(Bal1)))
    newWs.write(116, 17, '{:.4f}'.format(np.mean(AUC1)))
