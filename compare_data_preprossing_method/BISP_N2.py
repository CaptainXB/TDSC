...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        bda = BDA(kernel_type='primal', dim=5, lamb=0.9, mu=0.9, mode='BDA', gamma=1, estimate_mu=True)
    ...
    # newWs.write(25, 16, '{:.4f}'.format(np.mean(PD1)))
    # newWs.write(56, 16, '{:.4f}'.format(np.mean(PF1)))
    # newWs.write(87, 16, '{:.4f}'.format(np.mean(Bal1)))
    # newWs.write(118, 16, '{:.4f}'.format(np.mean(AUC1)))
