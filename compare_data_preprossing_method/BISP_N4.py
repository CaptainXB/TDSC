...
linux_y = linux_y.reshape(1734, 1)
...
if __name__ == '__main__':
    ...
    newWs.write(27, 17, '{:.4f}'.format(np.mean(PD1)))
    newWs.write(58, 17, '{:.4f}'.format(np.mean(PF1)))
    newWs.write(89, 17, '{:.4f}'.format(np.mean(Bal1)))
    newWs.write(120, 17, '{:.4f}'.format(np.mean(AUC1)))
