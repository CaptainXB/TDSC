...
if __name__ == '__main__':
    ...
    # newWs.write(14, 5, '{:.4f}'.format(np.mean(PD1)))
    # newWs.write(45, 5, '{:.4f}'.format(np.mean(PF1)))
    # newWs.write(76, 5, '{:.4f}'.format(np.mean(Bal1)))
    # newWs.write(107, 5, '{:.4f}'.format(np.mean(AUC1)))
