...
if __name__ == '__main__':
    ...
    # newWs.write(7, 17, '{:.4f}'.format(np.mean(PD1)))
    # newWs.write(38, 17, '{:.4f}'.format(np.mean(PF1)))
    # newWs.write(69, 17, '{:.4f}'.format(np.mean(Bal1)))
    # newWs.write(100, 17, '{:.4f}'.format(np.mean(AUC1)))
