...
if __name__ == '__main__':
    ...
    newWs.write(4, 17, '{:.4f}'.format(np.mean(PD1)))
    newWs.write(35, 17, '{:.4f}'.format(np.mean(PF1)))
    newWs.write(66, 17, '{:.4f}'.format(np.mean(Bal1)))
    newWs.write(97, 17, '{:.4f}'.format(np.mean(AUC1)))
