...
class TCA:
    ...
    def fit_predict(self, Xs, Ys, Xt, Yt):
        ...
        Bal = 1 - math.sqrt(((0 - PF) * (0 - PF) + (1 - PD) * (1 - PD)) / 2)
        # list_acc.append(acc)
        # print('TCA iteration [{}]: PD: {:.4f}'.format(1, PD))
        # print('TCA iteration [{}]: PF: {:.4f}'.format(1, PF))
        # print('TCA iteration [{}]: Bal: {:.4f}'.format(1, Bal))
        # print('TCA iteration [{}]: AUC: {:.4f}'.format(1, AUC))
        # print('TCA iteration [{}]: bal_gailv: {:.4f}'.format(1, bal))
            ...
            if source_name == target_name:
                ...
                for model in train_model:
                    ...
                    for i in range(10):
                        ...
                        bda = TCA(kernel_type='primal', dim=5, lamb=1, gamma=1, model=model)
                    ...
                    if left == 0:
                        ...
                        col = 12
                    savedata('F:\\paper result\\transfer learning compare_new.xls', 4 + down*9, index + col, performance)
                    index += 1
                left += 1
        down += 1
